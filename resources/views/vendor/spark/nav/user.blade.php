...
<spark-navbar
    ...
    <nav class="navbar navbar-light navbar-expand-md navbar-seamless">
                ...
                <ul class="navbar-nav ml-4">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                            ...
                            <!-- Profile -->
                            <h6 class="dropdown-header">{{__('Profile')}}</h6>

                            <!-- Your Profile -->
                            <a class="dropdown-item" href="/profile">
                                <i class="fa fa-fw text-left fa-btn fa-user-circle"></i> {{__('Your Profile')}}
                            </a>
